...
def generate_launch_description():
    ...
    #     name="joy", default_value="True", description="Activates joy tele-operation"
    # )
    ...
    #     name="nav", default_value="True", description="Activates the navigation stack"
    # )
    ...
    ros_gz_image_bridge = Node(
        package="ros_gz_image", executable="image_bridge", arguments=["/camera/image"]
    )
